...
Both networks are [deep convolutional neural networks (CNNs)](https://arxiv.org/abs/1511.08458) that take the current board position as input.
...
The shows that AlphaGo Zero initially picks up some patterns but discards them after further training if they are deemed inferior. 
